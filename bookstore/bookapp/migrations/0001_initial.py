# Generated by Django 3.1.2 on 2022-02-03 12:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('pdf', 'PDF'), ('only hard copy', 'only hard copy')], max_length=200, null=True)),
